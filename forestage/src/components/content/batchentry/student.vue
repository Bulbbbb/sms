  ...
  <div>
    ...
    <el-main>
      <el-table :data="da" class="mytable" height="530">
        ...
        <el-table-column prop="sNum" label="学号"> </el-table-column>
        <el-table-column prop="sSex" label="性别"> </el-table-column>
        <el-table-column prop="sIns" label="学院"> </el-table-column>
        <el-table-column prop="sMaj" label="专业"> </el-table-column>
        <el-table-column prop="sCla" label="班级"> </el-table-column>
      </el-table>
    </el-main>
...
<script>
import { studentBat } from "@/network/batchentry.js";
  ...
  methods: {
    exportExcel() {
      require.ensure([], () => {
        ...
        // 上面设置Excel的表格第一行的标题
        const filterVal = ["sName", "sNum", "sSex", "sIns", "sMaj", "sCla"];
    ...
    update() {
      studentBat(this.da, this.$store.state.userMsg.uNum).then((res) => {
        // console.log(res);
