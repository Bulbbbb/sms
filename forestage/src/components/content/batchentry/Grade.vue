  ...
  <div>
    ...
    <el-main>
      <el-table :data="da" class="mytable"  height="530" >
        <el-table-column prop="cour" label="课程"> </el-table-column>
        <el-table-column prop="name" label="姓名"> </el-table-column>
        <el-table-column prop="num" label="学号"> </el-table-column>
        <el-table-column prop="sch" label="学期"> </el-table-column>
        <el-table-column prop="cla" label="班级"> </el-table-column>
        <el-table-column prop="gra" label="成绩"> </el-table-column>
      </el-table>
    </el-main>
  ...
  methods: {
    exportExcel() {
      require.ensure([], () => {
        ...
        // 上面设置Excel的表格第一行的标题
        const filterVal = ["name", "name", "name", "name", "name"];
